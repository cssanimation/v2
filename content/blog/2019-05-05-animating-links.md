...
<article class="content">
  <p>
    ... and here is some text. This text shows how
    <a href="https://cssanimation.rocks/">CSS animation</a> can help us make
    links be more fun and useful...
  </p>
</article>
```
...
Back to the CSS. In our `links.css` stylesheet file, set the anchor styling to `text-decoration: none`, and the same on `hover`.
...
Returning to the CSS file, let's add the `after` pseudo-element.
